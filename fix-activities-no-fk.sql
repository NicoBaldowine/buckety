-- Fix activities table - add user_id column WITHOUT foreign key

-- Step 1: Add the user_id column as a simple UUID (no foreign key)
...
-- Step 6: Create simple RLS policies based on bucket ownership
...
-- Step 7: Create function to auto-populate user_id
